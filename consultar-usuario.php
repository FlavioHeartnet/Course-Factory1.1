        ...
        <div class="fourteen wide column">
            ...
            <div class="ui search">
                <div class="ui icon input">
                    <input class="prompt"  onkeyup="buscarNoticias(this.value)" type="text" placeholder="Procurar Usuarios...">
...
// Arquivo PHP juntamento com a id da noticia (método GET)
        var url = "buscas/exibirUsuario.php?id="+id;
...
// Arquivo PHP juntamente com o valor digitado no campo (método GET)
        var url = "buscas/buscaUsuario.php?valor="+valor;
...
// Quando o objeto recebe o retorno, chamamos a seguinte função;
        req.onreadystatechange = function() {
            ...
            if(req.readyState == 1) {
                document.getElementById('resultado').innerHTML = 'Buscando Usuario...';
            }
